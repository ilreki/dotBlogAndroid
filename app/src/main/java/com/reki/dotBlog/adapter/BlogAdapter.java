...
public class BlogAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BlogAdapter(JSONArray data, Context context, boolean hasMore) {
        this.data = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == normalType) {
            return new NormalHolder(LayoutInflater.from(context).inflate(R.layout.blog_view, null));
        } else {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
        if (holder instanceof NormalHolder) {
            try{
                ...
                ((NormalHolder) holder).title.setText(jsonObject.getString("blogTitle"));
                ((NormalHolder) holder).date.setText(jsonObject.getString("blogDate"));
                ((NormalHolder) holder).content.setText(jsonObject.getString("blogContent"));
    ...
    class NormalHolder extends RecyclerView.ViewHolder {
        ...
        public NormalHolder(View itemView) {
            super(itemView);
            title = itemView.findViewById(R.id.blog_view_title);
            date = itemView.findViewById(R.id.blog_view_date);
            content = itemView.findViewById(R.id.blog_view_content);
        }
    }

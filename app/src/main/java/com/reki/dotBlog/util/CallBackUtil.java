...
public abstract class CallBackUtil<T> {
    ...
    public static abstract class CallBackJson extends CallBackUtil<JSONObject>{
        @Override
    ...
    public static abstract class CallBackJsonArray extends CallBackUtil<JSONArray>{
        @Override
    ...
    public static abstract class CallBackBitmap extends CallBackUtil<Bitmap>{
        ...
        private Bitmap getZoomBitmap(Response response) {
            ...
            if(mTargetHeight == 1){
                mTargetHeight = (int) (mTargetWidth * ((float)picHeight / (float)picWidth));
            }

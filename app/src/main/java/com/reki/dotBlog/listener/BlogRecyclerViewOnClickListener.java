...
//博文item点击监听器
public class BlogRecyclerViewOnClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public BlogRecyclerViewOnClickListener(Context context, final RecyclerView recyclerView, OnItemClickListener onItemClickListener){

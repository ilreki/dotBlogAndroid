...
//回复item点击监听器
public class ReplyRecyclerViewOnClickListener implements RecyclerView.OnItemTouchListener {
    ...
    public ReplyRecyclerViewOnClickListener(Context context, final RecyclerView recyclerView, OnItemClickListener onItemClickListener){
        ...
        gestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener(){
            ...
            public boolean onSingleTapUp(MotionEvent e) {
                ...
                if(childView != null){
                    ...
                    ReplyAdapter adapter = (ReplyAdapter) recyclerView.getAdapter();
